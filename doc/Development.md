# Development and Testing Guide <br/> Statistics Microservice Client SDK for Node.ks
...
```bash
git clone git@github.com:pip-services-infrastructure/pip-clients-statistics-node.git
```
