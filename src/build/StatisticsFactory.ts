...
export class StatisticsFactory extends Factory {
	...
	constructor() {
		...
		this.registerAsType(StatisticsFactory.NullClientV1Descriptor, StatisticsNullClientV1);
		this.registerAsType(StatisticsFactory.DirectClientV1Descriptor, StatisticsDirectClientV1);
		this.registerAsType(StatisticsFactory.HttpClientV1Descriptor, StatisticsHttpClientV1);
		this.registerAsType(StatisticsFactory.SenecaClientV1Descriptor, StatisticsSenecaClientV1);
	}
